...
# Raised to 10 -- the user wants only perfect-score setups surfaced, not
# just the top band. A 10 requires every scoring flag to hit, so alerts are
# reserved for setups with no missing confluence at all.
MIN_ALERT_SCORE = int(os.environ.get("MIN_ALERT_SCORE", "10"))
